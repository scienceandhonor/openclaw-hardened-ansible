...
- **deploy-tier2.sh extra-vars format:** positional args extend to `sys.argv[25]` — `[11]`=`email_imap_host`, `[12]`=`email_imap_user`, `[13]`=`email_imap_password`, `[14]`=`email_imap_folder`, `[15]`=`rp_telegram_bottoken`, `[16]`=`reddit_enabled` (string `"true"`/`"false"`, converted to bool with `== 'true'`), `[17]`=`xurl_force_token` (string `"true"`/`"false"`, converted to bool), `[18]`=`gemini_key`, `[19]`=`openrouter_key`, `[20]`=`molt_api_key`, `[21]`=`molt_agent_name`, `[22]`=`anthropic_api_key`, `[23]`=`stoic_telegram_bottoken`, `[24]`=`obsidian_repo_slug`, `[25]`=`mistral_key`.
